---
title: "Creating Custom R Markdown Formats"
---
...
2. Sets a custom default height and width for figures (note this isn't user-customizable so as to encourage a standard for all reports of this type).
