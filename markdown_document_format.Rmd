...
The [pandoc markdown specification](http://johnmacfarlane.net/pandoc/demo/example9/pandocs-markdown.html) defines all of the markdown extensions and their name to be used in composing custom variants.

### Using Variants for Publishing
