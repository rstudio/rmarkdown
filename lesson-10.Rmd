...
In [How It Works](lesson-2.html), you learned that R Markdown files provide a [notebook interface](/r_notebooks.html) that makes it easy to test and iterate when writing code. 
...
See [R Notebooks](/r_notebooks.html) to learn more about notebooks with R Markdown.
