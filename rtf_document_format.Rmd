...
Installing the current [Preview Release of RStudio](https://www.rstudio.com/products/rstudio/download/preview/) (v0.99.849 or higher) is also highly recommended as it includes support for previewing RTF documents using Microsoft Word.
