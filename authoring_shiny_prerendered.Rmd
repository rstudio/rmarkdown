...
<script src="flexdashboard/ace-1.2.3/ace.js" type="text/javascript" charset="utf-8"></script>
<script src="flexdashboard/holder-2.9.0/holder.min.js" type="text/javascript" charset="utf-8"></script>
<script src="flexdashboard/snippets/snippets.js" type="text/javascript" charset="utf-8"></script>

## Overview

The traditional way to add Shiny components to an R Markdown document is through the use of [`runtime: shiny`](https://bookdown.org/yihui/rmarkdown/shiny-documents.html). This method provides a very straightforward development experience (you can use Shiny UI and server functions anywhere you like within the document). However, because it requires a full document render for each end user browser session it can perform poorly for documents that don't render quickly.
...
Here's a complete example of a [flexdashboard](/flexdashboard) implemented with `runtime: shiny_prerendered`:
