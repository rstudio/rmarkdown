...
![](images/shiny-prerendered-rstudio.png){.screenshot style="margin-bottom: 12px;"}
...
See the [Deployment] section below for details on deploying `runtime: shiny_prerendered` documents into various types of Shiny Server environments.
...
You can then deploy your `runtime: shiny_prerendered` document the same way that you currently deploy Shiny applications. From the working directory containing the document(s) just execute:
...
![](images/shinyapps-deploy-faithful.png){style="margin-bottom: 12px;"}
