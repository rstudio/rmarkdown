...
If you are running RStudio you should also download the [Preview Release](https://www.rstudio.com/products/rstudio/download/preview/) of RStudio (v1.0.136 or later) as it includes features that allow you easily run and preview `runtime: shiny_prerendered` documents within the IDE. 
...
Assuming you are using the [Preview Release](https://www.rstudio.com/products/rstudio/download/preview/) of RStudio (v1.0.136 or later) you can execute a `runtime: shiny_prerendered` document locally using the **Run Document** command on the editor toolbar, or use the keyboard shortcut Ctrl+Shift+K (Cmd+Shift+K on Mac):
