...
1. The [Posit community](https://forum.posit.co/c/quarto-r-markdown/) is a friendly place to ask any questions about rmarkdown and the R Markdown family of packages.
