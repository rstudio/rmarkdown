...
You can format the text in your R Markdown file with [Pandoc's Markdown](authoring_pandoc_markdown.html), a set of markup annotations for plain text files. When you render your file, Pandoc transforms the [marked up text](demos/5-markdown.Rmd) into formatted text in your final file format:

<!-- Screenshot of 5-markdown.Rmd rendered.
![]()
-->
...
## [Continue to Output Formats](lesson-8.html)
