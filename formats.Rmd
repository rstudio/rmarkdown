  ...
  <div class="columns">
    ...
    <div class="formatSection">
      ...
      <div class="formatTable">
        ...
        <a href="http://slides.yihui.name/xaringan/" class="formatTableRow">
          <div class="formatName">xaringan</div>
          <div class="formatDescription">HTML presentation with remark.js</div>
        </a>
