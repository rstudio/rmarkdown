...
* [Interactive Documents](authoring_shiny.html), which describes how to make R Markdown documents interactive using [Shiny](http://shiny.rstudio.com).
...
* Adding interactive components to R Markdown documents using [Shiny Widgets](developer_shiny_widgets.html).
