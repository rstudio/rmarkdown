...
<div id="homeContent">
  ...
  <div class="band full gray1 second leftText">
    <div class="bandContent vCenter">
      <div class="blurb">
        <div>R Markdown documents are fully reproducible. Use a productive notebook interface to weave together narrative text and R code to produce elegantly formatted output. So long copy & paste.</div>
      </div>
    </div>
  ...
  <div class="band full third rightText">
    <img class="imageThree" src="images/bandThree.png"/>
    <div class="bandContent vCenter">
      <div class="blurb">
        <div>
          ...
          shiny applications, scientific articles, <a href="rmarkdown_websites.html">websites</a>, and more.
        </div>
        <div class="actions">
          <div><a href="gallery.html"><button class="bigButton gallery">See Gallery</button></a></div>
          <div><a href="start.html"><button class="bigButton getStarted">Get Started</button></a></div>
        </div>
      </div>
    </div>
  </div>
