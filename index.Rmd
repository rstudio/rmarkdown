...
Note that in the case using the "Knit" button in RStudio the underlying mechanism is the same (RStudio calls the `rmarkdown::render` function under the hood).
