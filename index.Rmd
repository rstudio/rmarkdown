...
* [Shiny in R Markdown](authoring_shiny.html), which describes how to include Shiny components within R Markdown documents.
...
* Adding new types of HTML output to R Markdown documents using [HTML Widgets](developer_html_widgets.html).
    
* Building [Paramaterized Reports](developer_paramaterized_reports.html) that are callable via an R function
