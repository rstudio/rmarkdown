...
* Extensiblity: create custom templates and even entirely new output formats (for example, see the [Tufte Handout](tufte_handout_format.html) format).
...
1. RStudio --- Install the [latest version of RStudio](http://www.rstudio.com/products/rstudio/).
...
* Adding interactive components to R Markdown documents using [Shiny Widgets](authoring_shiny_widgets.html).
