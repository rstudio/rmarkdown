...
The `odt_document` format is currently only available within the development version of the **rmarkdown** package. You can install the development version as follows:
