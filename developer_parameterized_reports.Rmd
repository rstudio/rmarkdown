...
Note that parameterized reports are a new feature of R Markdown and currently require the latest version of the **knitr** package and the **development version** of the R Markdown package. You can install the required versions with the following commands:
