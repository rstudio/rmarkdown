...
Set the `output_format` argument of `render` to render your .Rmd file into any of R Markdown's supported formats. For example, the code below renders 1-example.Rmd to a Microsoft Word document. You can try it out [here](https://posit.cloud/content/181952) on RStudio Cloud. 
