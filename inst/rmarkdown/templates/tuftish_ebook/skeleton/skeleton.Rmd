...
\phantomsection % Tells LaTeX to put a placeholder here that can be linked-to with internal references
\section*{Introduction} % Insert a section heading without numbering, and don't put it in the table of contents
\addcontentsline{toc}{section}{Introduction} % Add an entry to the table of contents, formatted as a section
...
```{r fullwidthxtable,results='asis'}
