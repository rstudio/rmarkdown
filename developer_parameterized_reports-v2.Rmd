...
Sometimes the default value for a parameter is more naturally expressed as empty or missing. For example, a `maxrows` parameter might be available but when not specified results in all rows being utilized. See the [Empty Default Values] section below for details on specifying empty values.
