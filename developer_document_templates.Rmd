...
```bash
inst/rmarkdown/templates/my_template/template.yaml 
...
inst/rmarkdown/templates/my_template/template.yaml 
inst/rmarkdown/templates/my_template/skeleton/skeleton.Rmd 
inst/rmarkdown/templates/my_template/skeleton/logo.png 
inst/rmarkdown/templates/my_template/skeleton/styles.css 
```
