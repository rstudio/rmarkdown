...
This document includes an overview of Tufte Handouts and the various techniques used for formatting footnotes, sidenotes, figures, tables, etc.

The Tufte Handout format is also intended as an example of creating a LaTeX based custom R Markdown template. If you are interested in creating your own formats see the source code for the Tufte Handout [format](https://github.com/rstudio/rmarkdown/blob/master/R/tufte_handout.R) and [custom template](https://github.com/rstudio/rmarkdown/tree/master/inst/rmarkdown/templates/tufte_handout). In addtion, the **Developer** section of this website includes additional documentation on creating your own formats and templates.
