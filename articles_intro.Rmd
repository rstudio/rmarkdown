...
`echo` and `eval` are not the only arguments that you can use to customize code chunks. You can learn more about formatting the output of code chunks at the [rmarkdown](/authoring_rcodechunks.html) and [knitr](http://yihui.name/knitr/options) websites.
...
Visit [rmakdown.rstudio.com](/html_document_format.html) to learn about more YAML options that control the render process.
