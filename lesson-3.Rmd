...
#### | **[ 1 ](lesson-1.html)** |  **[ 2 ](lesson-2.html)** |  Lesson 3
***
...
You will also need a copy of your solution to exercise 2. You can download one [here](exercise-3.Rmd). Solutions will build on each other for the rest of the tutorial.
...
cat(htmltools::includeText("solution-3.Rmd"))
```
