...
<a href="https://r4ds.had.co.nz/"><img src="https://raw.githubusercontent.com/hadley/r4ds/master/cover.png" alt="" width="250" style="padding: 0 15px; float: right;"/></a>

If you are new to using R Markdown, we encourage you to start with a systematic overview, rather than diving right in to reading documentation pages. The best place to start is the ["Communication" section](https://r4ds.had.co.nz/communicate-intro.html) in the book [R for Data Science](https://r4ds.had.co.nz/) (R4DS for short), an O’Reilly book written by Hadley Wickham and Garrett Grolemund. You can read it [online for free](https://r4ds.had.co.nz/), or [buy a physical copy](https://www.amazon.com/R-Data-Science-Hadley-Wickham/dp/1491910399/ref=as_li_ss_tl?ie=UTF8&qid=1469550189&sr=8-1&keywords=R+for+data+science&linkCode=sl1&tag=devtools-20&linkId=6fe0069f9605cf847ed96c191f4e84dd).

Here are the chapters that cover R Markdown, as [summarized by Hadley and Garrett](https://r4ds.had.co.nz/communicate-intro.html):
...
<a href="https://rmarkdown.rstudio.com/lesson-1.html"><img src="https://raw.githubusercontent.com/rstudio/rmarkdown/gh-pages/lesson-images/params-1-hawaii.png" alt="" width="450" style="padding: 0 15px; float: right;"/></a>
...
Written by the authors of the rmarkdown package, [R Markdown: The Definitive Guide](https://bookdown.org/yihui/rmarkdown/) provides a comprehensive user guide to the complete R Markdown ecosystem for authoring documents. The book is published by [Chapman & Hall/CRC](https://www.crcpress.com/R-Markdown-The-Definitive-Guide/Xie-Allaire-Grolemund/p/book/9781138359338) and you can read it [online for free](https://bookdown.org/yihui/rmarkdown/), or [buy a physical copy](https://www.amazon.com/Markdown-Definitive-Guide-Chapman-Hall/dp/1138359335/ref=sr_1_2?crid=2ARZ1GUXDSGYZ&keywords=r+markdown+the+definitive+guide&qid=1555525356&s=gateway&sprefix=rmarkdown%2Caps%2C205&sr=8-2-spell).

<a href="https://bookdown.org/yihui/rmarkdown/"><img src="https://raw.githubusercontent.com/rstudio/rmarkdown-book/master/images/cover.png" alt="" width="250" style="padding: 0 15px; float: right;"/></a>
...
<a href="https://github.com/rstudio/cheatsheets/raw/master/rmarkdown-2.0.pdf"><img src="https://www.rstudio.com/wp-content/uploads/2018/08/rmarkdown-2.0.png" alt="" width="450" style="padding: 0 15px; float: right;"/></a>
