...
> Let's note we use [`break-after`
property](https://developer.mozilla.org/en-US/docs/Web/CSS/break-after) here
instead of `page-break-after` as it is recommended now to use the former which
will be the replacement. The latter is kept around for [compatibility reason
with browsers](https://caniuse.com/#search=page-break).
