...
1. Create a shared options file (output.yaml) to ensure common options across all pages within the site.
...
For example, here's a possible output.yaml file for a website:
