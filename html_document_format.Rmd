...
Support for creating websites as described above is only available in very recent versions of the **rmarkdown** package. You can install the most current version as follows:
