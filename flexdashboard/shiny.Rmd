...
Note that special handling of the `global` chunk is a feature currently only available within the development version of the **rmarkdown** package. You can install this version as follows:
