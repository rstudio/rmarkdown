...
merge_output_formats <- function(base, overlay)  {
  structure(list(
    ...
    allow_html_dependencies =
      merge_scalar(base$allow_html_dependencies, overlay$allow_html_dependencies),
    clean_supporting =
...
is_pandoc_to_markdown <- function(options) {
  grepl(pattern = "^markdown", x = options$to) 
}
