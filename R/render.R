...
#'   [pdf_document()] and [beamer_presentation()].
#' @name rmd_metadata
NULL
...
#' }
#'   The first call to [render()] creates an HTML document, whereas
...
#' [html_document()], [pdf_document()]) or a format defined
...
#' @param encoding The encoding of the input file. See [file()] for
#' more information.
#' @return
