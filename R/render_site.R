...
#'   \item{The following files are **not** copied to the `_site`
#'   sub-directory:
#'     \itemize{
...
#' \itemize{
#'   \item{`name`} {The name for the website (e.g. the parent directory
#'   name).}
#'   \item{`output_dir` {The directory where the website output is written
#'   to. This path should be relative to the site directory (e.g. `.` or
#'   `_site`)}}
#'   \item{`render`} {An R function that can be called to generate the
#'   site. The function should accept the `input_file`,
#'   `output_format`, `envir`, `quiet`, and `encoding`
#'   arguments.}
#'   \item{`clean`} {An R function that returns relative paths to the files
...
#' @param recursive `TRUE` to return a full recursive file listing;
#'   `FALSE` to just provide top-level files and directories.
#'
