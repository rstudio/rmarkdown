...
#'   features of \code{html_document} won't be available (see the Templates
...
#'   \href{http://pandoc.org/README.html}{pandoc documentation}. You can also
#'   use the basic pandoc template by passing \code{template = NULL}.
#'
