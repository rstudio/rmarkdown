...
#'  make it works. For now, \code{highlight = "default"} will use this engine.
#'  In next versions, highghlightjs engine could be removed.
#'
...
#'  parameter:
#'  \itemize{
#'  \item{"arrow", an accessible color theme derived from \href{optimized for
