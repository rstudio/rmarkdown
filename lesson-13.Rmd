...
Render collections of R Markdown documents into a website with the `rmarkdown::render_site` function. Each .Rmd file becomes a page of the site. Here we build a website from [these files](demos/12-website.zip).
...
Learn more about generating websites with R Markdown at [R Markdown Websites](/rmarkdown_websites.html).
